const sidebar_chips = [
    {
        ...
        items: [
            ...
            {
                text: 'Loongson 3 processor family',
                items: [
                    {
                        text: '3A6000',
                        collapsed: true,
            ...
            {
                text: 'Loongson 2 processor family',
                items: [
                    {
                        text: '2K3000',
                        collapsed: true,
                        base: "/en/chips/cpu/2k3000/",
                        items: [
